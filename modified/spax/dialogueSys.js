...
class dialogueSys
{
    ...
    resetBoxTo (text)
    {
        ...
        for (let i = 0; i < text.length; i++)
        {
            modifiedText += `<span id="dialogueSysChar_${this.charIndex + i}" style="display : inline-block; color : ${this.textColor}; background : ${this.textBg};">${text[i]} font-style : ${this.textStyle}; font-weight : ${this.textWeight};</span>`;
        }
